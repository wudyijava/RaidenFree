...
void BmobQuery::addWhereEqualTo(string seg,Ref *object){
    if (object == NULL)
    {
        /* code */
        return ;
    }
    this->m_whereData.insert(pair<string,Ref*>(seg,object));
}

void BmobQuery::addWhereNotEqualTo(string seg,Ref *object){
...
void BmobQuery::addWhereLessThanOrEqualTo(string seg,Ref *object){
    __Integer* value = dynamic_cast<__Integer*>(object);
    if (!value)
    {
        /* code */
...
void BmobQuery::addWhereGreaterThan(string seg,Ref *object){
     __Integer* value = dynamic_cast<__Integer*>(object);
    if (!value)
    {
        /* code */
...
void BmobQuery::addWhereGreaterThanOrEqualTo(string seg,Ref *object){
     __Integer* value = dynamic_cast<__Integer*>(object);
    if (!value)
    {
        /* code */
...
void BmobQuery::addWhereContainedIn(string seg,Ref* array){
    __Array* arr = dynamic_cast<__Array*>(array);
    if (!arr)
    {
        /* code */
        return ;
...
void BmobQuery::addWhereNotContainedIn(string seg,Ref* array){
    __Array* arr = dynamic_cast<__Array*>(array);
    if (!arr)
    {
        /* code */
...
void BmobQuery::addWhereContainsAll(string seg,__Array* array){
     if (!array)
    {
        /* code */
        return ;
...
void BmobQuery::addWhereExists(string column){
    ...
    __Dictionary* pDict = __Dictionary::create();
    __Bool* bol = __Bool::create(true);
    pDict->setObject(bol, "$exists");
    this->m_whereData.insert(pair<string,Ref*>(column,pDict));
}
...
void BmobQuery::addWhereDoesNotExists(string column){
    ...
    __Dictionary* pDict = __Dictionary::create();
    __Bool* bol = __Bool::create(false);
    pDict->setObject(bol, "$exists");
    this->m_whereData.insert(pair<string,Ref*>(column,pDict));
}
...
void BmobQuery::onHttpRequestCompleted(cocos2d::Node *pSender,void *data){
